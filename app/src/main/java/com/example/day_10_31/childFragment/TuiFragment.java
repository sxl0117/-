...
import com.example.day_10_31.adapter.TuiAdapter;
...
public class TuiFragment extends Fragment {
        ...
        new Retrofit.Builder()
                ...
                .subscribe(new Observer<TuiBean>() {
                    ...
                    public void onNext(TuiBean tuiBean) {
                        List<TuiBean.DataBeanX.DataBean> data = tuiBean.getData().getData();
                        tuiAdapter.addItem(data);
                    }
    ...
    private void initView(@NonNull final View itemView) {
        ...
        tuiAdapter = new TuiAdapter(getContext());
        mRec.setAdapter(tuiAdapter);
    }
}